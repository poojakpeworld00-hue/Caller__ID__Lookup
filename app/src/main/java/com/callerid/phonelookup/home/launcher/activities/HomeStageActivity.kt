package com.callerid.phonelookup.home.launcher.activities
...
import com.callerid.phonelookup.home.launcher.extensions.getLabel
import com.callerid.phonelookup.home.launcher.extensions.handleGridItemPopupMenu
...
import com.callerid.phonelookup.home.launcher.extensions.launchAppInfo
import com.callerid.phonelookup.home.launcher.extensions.launchersDB
import com.callerid.phonelookup.home.launcher.extensions.requestSetAsDefaultLauncher
import com.callerid.phonelookup.home.launcher.extensions.supportsDarkText
import com.callerid.phonelookup.home.launcher.extensions.uninstallApp
import com.callerid.phonelookup.home.launcher.fragments.BaseFragment
import com.callerid.phonelookup.home.launcher.helpers.CLOCK_ROW_SPAN
...
import com.callerid.phonelookup.home.launcher.helpers.ITEM_TYPE_SHORTCUT
...
import com.callerid.phonelookup.home.launcher.helpers.IconCache
import com.callerid.phonelookup.home.launcher.helpers.PSEUDO_WIDGET_CLOCK
import com.callerid.phonelookup.home.launcher.helpers.PSEUDO_WIDGET_SEARCH
import com.callerid.phonelookup.home.launcher.helpers.REQUEST_ALLOW_BINDING_WIDGET
import com.callerid.phonelookup.home.launcher.helpers.SEARCH_BAR_ROW
import com.callerid.phonelookup.home.launcher.helpers.REQUEST_CONFIGURE_WIDGET
import com.callerid.phonelookup.home.launcher.helpers.REQUEST_CREATE_SHORTCUT
import com.callerid.phonelookup.home.launcher.helpers.UNINSTALL_APP_REQUEST_CODE
import com.callerid.phonelookup.home.launcher.interfaces.FlingListener
...
import com.callerid.phonelookup.home.launcher.receivers.LockDeviceAdminReceiver
...
import com.callerid.phonelookup.home.util.applyNativeAdTheme

class HomeStageActivity : ShellDeckActivity(), FlingListener, HomeShellHost {
    ...
    override fun bringHostToFront() {
        runCatching {
            startActivity(
                Intent(this, HomeStageActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // language's resources. CanvasActivity does this for every other screen; this one does
        ...
        // native-ad palette keys are global, only ever written by CanvasActivity, which this is
        ...
        arrayOf(
            binding.allAppsFragment.root as BaseFragment<*>,
            binding.widgetsFragment.root as BaseFragment<*>
        ).forEach { fragment ->
        ...
        binding.leftPanel.root.apply {
            setupFragment(this@HomeStageActivity)
    ...
    override fun onResume() {
        ...
        // onboarding picker both live in other Activities). Same call CanvasActivity makes here.
        LocaleRegistry.applySaved(this)
    ...
    private fun launchSettings() {
        startActivity(
            Intent(this@HomeStageActivity, StageSettingsActivity::class.java)
        )
    }
    ...
    private class MyGestureListener(
        ...
        override fun onSingleTapUp(event: MotionEvent): Boolean {
            (flingListener as HomeStageActivity).homeScreenClicked(event.x, event.y)
            return super.onSingleTapUp(event)
        }

        override fun onDoubleTap(event: MotionEvent): Boolean {
            (flingListener as HomeStageActivity).homeScreenDoubleTapped(event.x, event.y)
        ...
        override fun onLongPress(event: MotionEvent) {
            (flingListener as HomeStageActivity).homeScreenLongPressed(event.x, event.y)
        }
    }
    ...
    private fun seedHomeWidgetsIfNeeded() {
        ...
        try {
            ...
            Log.e("HomeStageActivity", "Failed to seed default home widgets", e)
        }
    }
