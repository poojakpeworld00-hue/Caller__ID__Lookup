...
import com.callerid.phonelookup.home.launcher.helpers.MIN_COLUMN_COUNT
import com.callerid.phonelookup.home.launcher.helpers.MIN_ROW_COUNT
...
class StageSettingsActivity : ShellDeckActivity() {
    ...
    private fun setupCustomizeColors() {
        binding.settingsColorCustomizationHolder.setOnClickListener {
            // see ShellDeckActivity.withFossifyPackageNameSpoofed — startCustomizationActivity()
    ...
    private fun setupManageHiddenIcons() {
        binding.settingsManageHiddenIconsHolder.setOnClickListener {
            startActivity(Intent(this, VeiledAppsActivity::class.java))
        }
    }
}
