...
import com.callerid.phonelookup.home.launcher.helpers.REPOSITORY_NAME

open class ShellDeckActivity : BaseSimpleActivity() {
     ...
     * (com.callerid.phonelookup.home), not the unauthorized clone that check is meant to catch, so
