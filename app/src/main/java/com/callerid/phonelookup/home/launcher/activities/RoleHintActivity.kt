 ...
 *
 * [com.callerid.phonelookup.home.launcher.helpers.LauncherHintPrompt] starts it only once
...
class RoleHintActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        HintSheetActivity.applyMode(root, HintSheetActivity.MODE_HOME)
    ...
    companion object {
        ...
        fun intent(context: Context): Intent =
            Intent(context, RoleHintActivity::class.java)
