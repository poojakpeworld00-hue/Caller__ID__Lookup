    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        with(holder.binding) {
            ...
            val (iconRes, subColorRes) = when (item.type) {
                CallKind.INCOMING -> R.drawable.holder_arrow_down_left to R.color.on_surface_variant
                CallKind.OUTGOING -> R.drawable.holder_arrow_up_right to R.color.on_surface_variant
                CallKind.MISSED -> R.drawable.glyph_call_missed to R.color.danger
                CallKind.SPAM -> R.drawable.holder_shield_warning to R.color.spam_on
            }
