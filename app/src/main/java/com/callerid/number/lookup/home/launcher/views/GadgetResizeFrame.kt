...
import com.callerid.number.lookup.home.launcher.extensions.getCellCount
import com.callerid.number.lookup.home.launcher.helpers.MAX_CLICK_DURATION
import com.callerid.number.lookup.home.launcher.models.BoardItem

@SuppressLint("ViewConstructor")
class GadgetResizeFrame(context: Context, attrs: AttributeSet, defStyle: Int) : RelativeLayout(context, attrs, defStyle) {
    ...
    fun updateFrameCoords(
        ...
        sideMargins: Rect,
        gridItem: BoardItem,
        allGridItems: ArrayList<BoardItem>
    ) {
        frameRect = coords
