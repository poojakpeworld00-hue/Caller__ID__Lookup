...
import com.callerid.number.lookup.home.databinding.PanelContactsBinding
...
class PhonebookFragment : CarrierFragment<PanelContactsBinding>() {
    ...
    private fun onPermissionGranted() {
        ...
        com.callerid.number.lookup.home.services.PersonUploader
    ...
    private fun openDetail(contact: com.callerid.number.lookup.home.data.PersonItem) {
