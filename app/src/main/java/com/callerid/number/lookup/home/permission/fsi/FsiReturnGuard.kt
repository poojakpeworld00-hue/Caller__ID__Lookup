 ...
 * the FSI settings page (the `returnTo`); when [FsiPollService] broadcasts
 * [FsiPermit.ACTION_FSI_GRANTED], it re-launches the host to the front so the
...
class FsiReturnGuard(private val activity: Activity) {
    ...
    private val receiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            ...
            // EXACTLY mirrors the working overlay receiver (AppHomeActivity
