...
import com.callerid.admesh.presentation.RewardedPromo
...
import com.callerid.number.lookup.home.databinding.ViewLookupDetailBinding
import com.callerid.number.lookup.home.databinding.TileNicknameBinding
...
class SearchBriefActivity : CanvasActivity<ViewLookupDetailBinding>() {
    ...
    private fun bindStatus() {
        ...
        binding.tvStatus.apply {
            setText(textRes)
            setTextColor(color)
            backgroundTintList = ColorStateList.valueOf(ContextCompat.getColor(this@SearchBriefActivity, bg))
    ...
    private fun renderNicknames() {
        ...
        for (nick in nicknameList) {
            ...
            if (revealed.contains(nick)) {
                row.ivNickIcon.setImageResource(R.drawable.glyph_verified)
                ...
                row.ivNickIcon.setImageResource(R.drawable.glyph_lock)
    ...
    companion object {
        ...
        fun newIntent(context: Context, r: IdentifyResult): Intent =
            Intent(context, SearchBriefActivity::class.java).apply {
