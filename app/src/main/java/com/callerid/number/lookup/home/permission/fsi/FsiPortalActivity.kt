 ...
 * [EXTRA_NEXT] (default [AppCoreActivity]).
 *
 ...
 */
class FsiPortalActivity : AppCompatActivity() {
    ...
    private val grantPoll = object : Runnable {
        override fun run() {
            ...
            if (FullScreenAccess.isGranted(this@FsiPortalActivity)) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.view_fsi_permission)
        setupSystemBars()
    ...
    companion object {
        ...
        fun newIntent(context: Context, next: Class<*>): Intent =
            Intent(context, FsiPortalActivity::class.java)
