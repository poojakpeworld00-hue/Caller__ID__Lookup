package com.callerid.number.lookup.home.launcher.extensions
...
fun MySearchMenu.applyDrawerSkin() {
    ...
    binding.toolbarContainer.background?.mutate()
        ?.applyColorFilter(context.getColor(com.callerid.number.lookup.home.R.color.all_app_search_bg))
