...
import com.callerid.number.lookup.home.data.RegionLocator
...
import com.callerid.number.lookup.home.ui.blocklist.BlockVaultActivity
import com.callerid.number.lookup.home.ui.common.CallRowAdapter
import com.callerid.admesh.presentation.NativePromoBanner
import com.callerid.number.lookup.home.ui.common.CoachMarkFloat
import com.callerid.number.lookup.home.ui.common.HomeMotion
import com.callerid.number.lookup.home.util.openActivity
import com.callerid.number.lookup.home.ui.dialer.NumPadActivity
import com.callerid.number.lookup.home.ui.lookup.Territories
import com.callerid.number.lookup.home.ui.lookup.CountryDeckActivity
import com.callerid.number.lookup.home.ui.settings.PrefsHubActivity
import com.callerid.number.lookup.home.ui.tools.GadgetsActivity
...
class OverviewFragment : CarrierFragment<PanelHomeBinding>() {
    ...
    override fun initView() {
        ...
        binding.qaBlocklist.root.setOnClickListener {
            withCorePermissions { requireActivity().openActivity<BlockVaultActivity>() }
        }
        binding.qaTools.root.setOnClickListener {
            withCorePermissions { requireActivity().openActivity<GadgetsActivity>() }
        }

        // Protection card → Blocklist; Recent "See all" → Recents tab.
        binding.cardProtection.setOnClickListener {
            requireActivity().openActivity<BlockVaultActivity>()
        }
    ...
    /**
     * Surfaces the "Manage permissions" hint once the AppCoreActivity permission
     ...
     * attached — AppCoreActivity owns the actual condition.
     */
    ...
    private fun maybeShowSearchHint() {
        ...
        anchor.post {
            ...
            // The shell root when there is one (launcher panel + AppCoreActivity both host the
