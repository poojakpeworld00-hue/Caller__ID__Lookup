 ...
 *
 * This screen deliberately does NOT use [com.callerid.number.lookup.home.shell.ext
...
class HomeRoleGateActivity : ShellBaseActivity() {
    ...
    private fun openHomeSettings() {
        ...
        // The card follows the list rather than racing it — see SwipeCoachPrompt. It is a
