package com.callerid.number.lookup.home.ui.incall
...
import com.callerid.number.lookup.home.services.CallEndSentinel
import com.callerid.number.lookup.home.services.IdentCard
import com.callerid.admesh.presentation.SystemDialogKit
import com.callerid.number.lookup.home.services.onincomming.CallStateReceiver
 ...
 */
class IncomingRingActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun newIntent(context: Context, number: String): Intent =
            Intent(context, IncomingRingActivity::class.java)
