...
import com.callerid.number.lookup.home.ui.detail.CallReportActivity
...
class FeedFragment : CarrierFragment<PanelRecentsBinding>() {
    ...
    override fun initView() {
        ...
        binding.btnRecentsDial.setOnClickListener {
            requireActivity().openActivity<NumPadActivity>()
        }
    ...
    private fun openDetail(entry: com.callerid.number.lookup.home.data.CallRecord) {
        requireActivity().openActivity(CallReportActivity.newIntent(requireContext(), entry.number, entry.name))
    }
}
