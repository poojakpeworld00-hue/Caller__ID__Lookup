...
class GmaConsentRegistry private constructor(context: Context) {
    ...
    companion object {
        private var instance: GmaConsentRegistry? = null
        fun getInstance(context: Context): GmaConsentRegistry {
            if (instance == null) {
                instance = GmaConsentRegistry(context)
            }
