...
import com.callerid.admesh.data.PromoKind.*
import com.callerid.admesh.domain.PromoTallyRegistry.nativeCounter
...
class InlinePromo() {
    ...
    fun loadNativeADs(context: Activity, observer: NativeAdObserver? = null) {
        ...
        val adUnit = PerScreenPromo.nativeAdUnitId(context)
        if (adUnit.isEmpty()) {
            return
        }
        val adLoader =
                    ...
                    try {
                        ...
                        if (nativeAd != null) {
                            ...
                            if (BuildConfig.DEBUG) {
                                PromoRevenueGauge.simulateDebugRevenue(context)
                            }
