...
import com.callerid.admesh.data.OnFeedReady
import com.callerid.admesh.data.getLocationFromIP
import com.callerid.admesh.domain.PromoRevenueGauge
import com.callerid.admesh.domain.PromoConfigLoader
import com.callerid.admesh.domain.PromoVault
import com.callerid.admesh.domain.RemoteConfigRules
import com.callerid.admesh.domain.GmaConsentRegistry
import com.callerid.admesh.domain.logKeyEvent
import com.callerid.admesh.presentation.oninterAds.BackInterstitial
...
import com.callerid.number.lookup.home.permission.PermitSource
import com.callerid.number.lookup.home.permission.ScreenGlob
...
open class PromoAnchorActivity : AppCompatActivity() {
     ...
     * [com.callerid.number.lookup.home.permission.PermitEngine]
