...
class PromoVault constructor(context: Context) {
    ...
    companion object {
        ...
        @Volatile
        private var instance: PromoVault? = null

        fun getInstance(context: Context): PromoVault {
            return instance ?: synchronized(this) {
                instance ?: PromoVault(context.applicationContext).also {
                    instance = it
                }
            }
        }
